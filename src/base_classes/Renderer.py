...
# You can create functions which may be called from the environment here. These could be useful for, for example, highlighting specific spots in the simulation.
